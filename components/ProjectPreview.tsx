  ...
  return (
    <div className="relative mb-6 overflow-hidden rounded-2xl border border-white/10 bg-zinc-950">
      <div className="flex items-center gap-2 border-b border-white/10 bg-white/[0.04] px-4 py-3">
        ...
        <div className="ml-3 h-6 flex-1 rounded-full bg-black/40 px-3 text-[10px] leading-6 text-zinc-500">
          portfolio.dev/{title.toLowerCase().replaceAll(" ", "-")}
        </div>
      </div>

      <div className="relative h-44 overflow-hidden bg-[radial-gradient(circle_at_top_left,_rgba(139,92,246,0.45),_transparent_35%),radial-gradient(circle_at_bottom_right,_rgba(34,197,94,0.18),_transparent_30%)] p-5">
